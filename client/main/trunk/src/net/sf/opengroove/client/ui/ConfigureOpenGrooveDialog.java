 ...
 */
public class ConfigureOpenGrooveDialog extends
    javax.swing.JDialog
{
    ...
    public ConfigureOpenGrooveDialog(UserContext context)
    {
        super(context.getLaunchbar(), true);
        initGUI();
    }
    ...
    private void initGUI()
    {
        try
        {
            ...
            getContentPane().add(optionsTabbedPane,
                BorderLayout.CENTER);
            optionsTabbedPane
            ...
            optionsTabbedPane.addTab("General", null,
                generalPanel, null);
            // START >> jLabel9
            jLabel9 = new JLabel();
            generalPanel.add(jLabel9);
            jLabel9
                .setText("<html>We're still working on the Options dialog.<br/>Check out the other tabs to see what we have done so far.");
            jLabel9
            ...
            optionsTabbedPane.addTab("Connection", null,
                connectionTab, null);
            ...
            jLabel1
                .setText("You are currently connected to this server:");
            jLabel1.setBounds(32, 78, 293, 20);
            jLabel1.setFont(new java.awt.Font("Dialog", 0,
                12));
            // END << jLabel1
            ...
            mConnectedServerLabel.setBounds(97, 104, 366,
                19);
            mConnectedServerLabel
            ...
            jLabel2.setFont(new java.awt.Font("Dialog", 0,
                12));
            // END << jLabel2
            ...
            mConnectedPortLabel.setFont(new java.awt.Font(
                "Dialog", 1, 12));
            ...
            mConnectivityStatus.setFont(new java.awt.Font(
                "Dialog", 1, 12));
            ...
            jLabel3
                .setText("Your current connectivity status is:");
            jLabel3.setBounds(32, 29, 197, 17);
            jLabel3.setFont(new java.awt.Font("Dialog", 0,
                12));
            // END << jLabel3
            // START >> jLabel4
            jLabel4 = new JLabel();
            ...
            jLabel4.setFont(new java.awt.Font("Dialog", 0,
                12));
            // END << jLabel4
            // START >> mConnectionSecurityStatus
            mConnectionSecurityStatus = new JLabel();
            connectionTab
                .add(getMConnectionSecurityStatus());
            mConnectionSecurityStatus.setText("unknown");
            mConnectionSecurityStatus.setBounds(97, 191,
                99, 16);
            ...
            jLabel5.setFont(new java.awt.Font("Dialog", 0,
                12));
            // START >> jLabel6
            jLabel6 = new JLabel();
            connectionTab.add(jLabel6);
            jLabel6
                .setText("<html><font size='5'>Transmission:</font>");
            ...
            jLabel7
                .setText("<html><font size='4'>Me &rarr; Server</font>");
            ...
            jLabel8
                .setText("<html><font size='4'>Server &rarr; Me</font>");
            ...
            GridLayout commandStatPanelLayout = new GridLayout(
                0, 2);
            commandStatPanelLayout.setHgap(5);
            commandStatPanelLayout.setVgap(5);
            commandStatPanel
                .setLayout(commandStatPanelLayout);
            ...
            try
            {
                    ...
                    public synchronized void statsUpdated()
                    {
                            ...
                            .entrySet())
                        {
                                ...
                                .get(command) == null)
                            {
                                ...
                                OpenGroove
                                    .setPlainFont(amountLabel);
                                JLabel sizeLabel = new JLabel();
                                OpenGroove
                                    .setPlainFont(sizeLabel);
                                commandAmountLabels.put(
                                    command, amountLabel);
                                commandSizeLabels.put(
                                    command, sizeLabel);
                            ...
                            .entrySet())
                        {
                                ...
                                .get(response) == null)
                            {
                                ...
                                OpenGroove
                                    .setPlainFont(sizeLabel);
                                responseAmountLabels.put(
                                    response, amountLabel);
                                responseSizeLabels.put(
                                    response, sizeLabel);
                                responseStatPanel
                                    .add(label);
                                JPanel p1c = new JPanel();
                ...
                OpenGroove.ocom.communicator
                    .addStatisticsListener(statListener);
            }
            catch (Exception ex1)
            {
                ex1.printStackTrace();
            ...
            advancedTab
                .add(getNotificationOneTimeTestButton());
            notificationOneTimeTestButton
                .setText("Test one-time notification");
            notificationOneTimeTestButton.setBounds(82, 84,
                191, 26);
            notificationOneTimeTestButton
                .addActionListener(new ActionListener()
                {
