...
{
    private SVGPanel simpleGradientPanel1;
    ...
    private void initGUI()
    {
        try
        {
            ...
            chatPopoutFrame.getContentPane().setLayout(
                new BorderLayout());
            chatPopoutFrame.setSize(300, 400);
            chatPopoutFrame.setLocationRelativeTo(null);
            chatPopoutFrame.setIconImage(OpenGroove
                .getWindowIcon());
            chatPopoutFrame
            ...
            workspaceMembersPanel
                .setLayout(workspaceMembersPanelLayout);
            ...
            chatTaskPaneGroup.getContentPane().add(
                chatPanel);
            ...
            chatPanel.add(lowerChatPanel,
                BorderLayout.SOUTH);
            lowerChatPanel.setOpaque(false);
            // START >> chatTextField
            chatTextField = new JTextField();
            lowerChatPanel.add(getChatTextField(),
                BorderLayout.CENTER);
            chatTextField
                .setPreferredSize(new java.awt.Dimension(
                    -1, 0));
            ...
            lowerChatPanel.add(bothChatButtonsPanel,
                BorderLayout.EAST);
            
            sendChatButton = new JButton();
            bothChatButtonsPanel.add(sendChatButton,
                BorderLayout.WEST);
            sendChatButton.setText("Go");
            // START >> chatPopOutButton
            chatPopOutButton = new JLinkButton();
            chatPopOutButton.setBorder(new EmptyBorder(2,
                2, 2, 2));
            chatPopOutButton.setFocusable(false);
            bothChatButtonsPanel.add(getChatPopOutButton(),
                BorderLayout.EAST);
            ...
            commonTasksTaskPaneGroup
                .setText("Common Tasks");
