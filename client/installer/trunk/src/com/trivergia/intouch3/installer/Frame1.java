	...
	private synchronized JFileChooser getInstallFolderChooser()
	{
		if (installFolderChooser == null)
		{
			...
			installFolderChooser
					.setApproveButtonToolTipText("Install Convergia in this folder");
			installFolderChooser
