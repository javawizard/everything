		...
		JCollapsiblePane.JCollapsiblePaneContainer
{
	...
	public JTaskPaneGroup()
	{
		...
		collapsePane.addPropertyChangeListener(
				...
				new PropertyChangeListener()
				{
					...
					{
						JTaskPaneGroup.this.firePropertyChange(evt
	...
	public JTaskPaneGroup(String string)
	{
		this();
		setTitle(string);
	}
	...
	public void updateUI()
	{
		...
		setUI((TaskPaneGroupUI) LookAndFeelAddons.getUI(this,
				TaskPaneGroupUI.class));
	}
	...
	/**
	 * Sets this pane to be "special" or not. Marking a
	 * <code>JTaskPaneGroup</code> as <code>special</code> is only a hint
	 * for the pluggable UI which will usually paint it differently (by example
	 * by using another color for the border of the pane).
	 * 
	 * <p>
	 * Usually the first JTaskPaneGroup in a JTaskPane is marked as special
	 * because it contains the default set of actions which can be executed
	 ...
	 * 
	 * @param expanded
	 *            true to expand the group, false to collapse it
	 * @javabean.property bound="true" preferred="true"
	 */
	 ...
	 * component built from the action. The returned component has been added to
	 * the <code>JTaskPaneGroup</code>.
	 * 
	 * @param action
	...
	protected String paramString()
	{
		return super.paramString() + ",title=" + getTitle() + ",icon="
				+ getIcon() + ",expanded=" + String.valueOf(isExpanded())
