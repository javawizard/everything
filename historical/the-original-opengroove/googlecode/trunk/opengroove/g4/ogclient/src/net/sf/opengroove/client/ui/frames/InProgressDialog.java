    ...
    public static void main(String[] args)
    {
        SwingUtilities.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                InProgressDialog inst = new InProgressDialog(frame);
                inst.setVisible(true);
            }
        });
    }
    
    public InProgressDialog(JFrame frame)
    {
        super(frame);
        initGUI();
            ...
            }
            {
                ...
                TableLayout rootPanelLayout =
                    new TableLayout(new double[][] {
                        ...
                        { 20.0, TableLayout.PREFERRED, 10.0, 25.0, TableLayout.FILL,
                            20.0 } });
