...
public class BasicTaskPaneGroupUI extends TaskPaneGroupUI
{
	...
	class ChangeListener implements PropertyChangeListener
	{
		public void propertyChange(PropertyChangeEvent evt)
		{
			...
			if ((JTaskPaneGroup.EXPANDED_CHANGED_KEY.equals(evt
					.getPropertyName())
					&& Boolean.TRUE.equals(evt.getNewValue()) && !group
					.isAnimated())
					|| (JCollapsiblePane.ANIMATION_STATE_KEY.equals(evt
			...
			} else if (JTaskPaneGroup.ICON_CHANGED_KEY.equals(evt
					.getPropertyName())
					|| JTaskPaneGroup.TITLE_CHANGED_KEY.equals(evt
							.getPropertyName())
					|| JTaskPaneGroup.SPECIAL_CHANGED_KEY.equals(evt
							.getPropertyName())
					|| JTaskPaneGroup.COLLAPSABLE_CHANGED_KEY.equals(evt
							.getPropertyName()))
			{
	 ...
	 */
	protected class ContentPaneBorder implements Border
	{
		Color color;
	...
	protected class PaneBorder implements Border
	{
		...
		public PaneBorder()
		{
			...
			if (false)
			{
				titleBackgroundGradientStart = new Color(255, 255, 255, 0);
				titleBackgroundGradientEnd = new Color(255, 255, 255, 0);
			}
		...
		protected void paintTitle(JTaskPaneGroup group, Graphics g,
		...
		protected void paintChevronControls(JTaskPaneGroup group, Graphics g,
				int x, int y, int width, int height)
		{
			ChevronIcon chevron;
			if (group.isExpanded())
