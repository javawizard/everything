	...
	private void initGUI() {
		try {
			...
			getContentPane().setLayout(null);
			{
				...
				mainLabel.setText("<html>Welcome to InTouch Communicator! Before you<br/>can start using InTouch, you need to create an<br/>account. After you click OK, a window will open, asking<br/>you for your account information. If you already<br/>have an account, just enter your username and<br/>password. If you don't have an account, follow<br/>the directions for creating a new account.<br/><br/>NOTE: You must <u>not</u> use one account accross<br/>multiple computers. ");
