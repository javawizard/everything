...
public class LoginCommand implements Command<LoginPacket>
{
     ...
     * logging in twice
     */
    public synchronized void process(LoginPacket packet)
    {
        ...
        String realEncPassword = StringUtils.readFile(new File(userFolder, "password"));
        ...
        /*
         * PICK UP HERE, validate computer or make sure they didn't specify one,
         * then if there is a computer add to the connection map, if there isn't
         * just mark them as logged in. Make the userid absolute, and add an
         * equals and hashCode method to Userid.
         */
        if (computer != null)
        {
            ...
            {
                /*
                 * The computer that the user is trying to sign on as doesn't
                 * currently exist
                 */
