...
public class Installer
{
	...
	public static void main(String[] args) throws Throwable
	{
		...
		p.load(in);
		// now p has versionindex and url
		...
		try
		{
			...
			for (JarEntry entry : entrylist)
			{
				...
				if (!entry.getName().startsWith("appdata"))
					...
					System.out.println("entry was appdata, so don't extract");
				if (!entry.isDirectory()
						&& !entry.getName().startsWith("appdata"))
				{
